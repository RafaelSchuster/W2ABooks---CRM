    ...
    return (
        <>
            <tr>
                ...
                {!props.mobile && <td className="text-center">{props.title}</td>}
                <td className="text-center">{props.projectName}</td>
                {!props.mobile && <td className="text-center">{props.payment}</td>}
                {!props.mobile && <td className="text-center">{props.startDate}</td>}
                {!props.mobile && <td className="text-center">{props.endDate}</td>}
